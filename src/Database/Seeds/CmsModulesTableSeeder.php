...
class CmsModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cms_modules = array(
            ...
            array('id' => '32','name' => 'Page Manager','controller_name' => 'homepage','display_name' => 'Homepage Manager','parent_id' => '0','sub_title' => 'Homepage Manager','icon_css' => 'fa fa-file-code-o','list_view_name' => NULL,'edit_view_name' => NULL,'position' => '20','created_at' => NULL,'updated_at' => $date,'deleted_at' => NULL),
