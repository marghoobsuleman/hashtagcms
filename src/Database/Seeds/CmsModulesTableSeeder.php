...
class CmsModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cms_modules = array(
            ...
            array('id' => '16','name' => 'Themes','controller_name' => 'theme','display_name' => NULL,'parent_id' => '13','sub_title' => 'Mange theme','icon_css' => 'fa fa-object-group','list_view_name' => NULL,'edit_view_name' => NULL,'position' => '13','created_at' => NULL,'updated_at' => $date,'deleted_at' => NULL),
            ...
            array('id' => '23','name' => 'Static Modules','controller_name' => 'staticmodule','display_name' => NULL,'parent_id' => '13','sub_title' => 'Static module','icon_css' => 'fa fa-puzzle-piece','list_view_name' => NULL,'edit_view_name' => NULL,'position' => '16','created_at' => $date,'updated_at' => $date,'deleted_at' => NULL),
            array('id' => '32','name' => 'Pages Manager','controller_name' => 'homepage','display_name' => 'Homepage Manager','parent_id' => '0','sub_title' => 'Homepage Manager','icon_css' => 'fa fa-file-code-o','list_view_name' => NULL,'edit_view_name' => NULL,'position' => '20','created_at' => NULL,'updated_at' => $date,'deleted_at' => NULL),
