...
class CmsModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cms_modules = array(
            ...
            array('id' => '20','name' => 'Festival','controller_name' => 'festival','display_name' => NULL,'parent_id' => '5','sub_title' => 'Manage Festivals','icon_css' => 'fa fa-snowflake-o','list_view_name' => NULL,'edit_view_name' => NULL,'position' => '32','created_at' => $date,'updated_at' => $date,'deleted_at' => NULL),
