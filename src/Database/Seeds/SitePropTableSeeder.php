...
class SitePropTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $site_props = array(
            ...
            array('id' => '3','site_id' => '1','tenant_id' => '1','name' => 'Facebook','value' => 'https://www.facebook.com/hashtagcms','group_name' => 'SocialLinks','is_public' => '1','created_at' => $date,'updated_at' => $date,'deleted_at' => NULL),
