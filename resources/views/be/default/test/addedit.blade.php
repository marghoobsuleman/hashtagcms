...
@section('content')
    ...
    @php
        ...
        $id = 0;
        $lang = array();
        $lang["lang_id"] = old("lang_id");
        $lang["name"] = old("lang_name");


        $name = "Create your form here";
    ...
    @endphp
        ...
        <div class="row">
            <div class="admin-form">
                <form action="/admin/{{request()->module_info->controller_name}}/save" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    @include(htcms_admin_get_view_path('common.validationerror'))

                    <div class="form-group">
                        <label for="lang.name" class="col-sm-2">Name</label>
                        <div class="col-sm-10">
