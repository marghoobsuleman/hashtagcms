            ...
            <div class="admin-form">
                <form action="{{htcms_get_save_path(request()->module_info->controller_name)}}" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            {!!  FormHelper::label('permissions', 'Rights') !!}
                        </div>

                        <div class="col-sm-10">
                            <div class="col-sm-5">
                                <input type="hidden" value="0" name="updatePermission" id="updatePermission" />
                                {!! FormHelper::select('permissions[]', $allPermissions , array('class'=>'form-control', "id"=>"permissions", 'onChange'=>'document.getElementById("updatePermission").value = 1'), $permissions) !!}
                            </div>
                        </div>
                    </div>
