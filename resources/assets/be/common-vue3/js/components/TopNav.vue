    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          <li class="nav-item">
            <global-site-button :data-current-site="dataCurrentSite"></global-site-button>
          </li>
        </ul>
        <div class="d-flex">
...
<script>
import GloablSiteButton from "./GloablSiteButton.vue";
export default {
  components: {
    'global-site-button':GloablSiteButton
  },
  mounted() {
