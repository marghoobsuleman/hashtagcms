...
/***/ "./resources/assets/fe/common/js/components/Subscribe.js":
/*!***************************************************************!*\
  !*** ./resources/assets/fe/common/js/components/Subscribe.js ***!
  \***************************************************************/
  ...
  _createClass(Subscribe, [{
    ...
    value: function init() {
      ...
      if (document.querySelector(this.elements.close)) {
        document.querySelector(this.elements.close).addEventListener('click', function (ele) {
          document.querySelector(_this.elements.messageHolder).style.display = "none";
        });
      }
    }
  }, {
    key: "subscribeNow",
    value: function subscribeNow() {
      ...
      var email = document.querySelector(this.elements.form + " input[type='email']");
      var url = "/common-old/subscribe";
      var data = {
        email: email.value
      };
...
/***/ "./resources/assets/fe/common/js/utils/Analytics.js":
/*!**********************************************************!*\
  !*** ./resources/assets/fe/common/js/utils/Analytics.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Analytics = /*#__PURE__*/function () {
  ...
  _createClass(Analytics, [{
    ...
    key: "readCounter",
    value: function readCounter(data) {
      this.submit("post", "/analytics/publish", data).then(function (data) {})["catch"](function (data) {
        console.error(data);
      });
    }
    ...
    key: "submit",
    value: function submit(requestType, url, data) {
    ...
    key: "trackEventView",
    value: function trackEventView(category, action, value, cb) {
      try {
        //very very old ga
    ...
    key: "trackPageView",
    value: function trackPageView(value, cb) {
      try {
        //Very very old ga
...
"use strict";
/*!*********************************************!*\
  !*** ./resources/assets/fe/basic/js/app.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");
/* harmony import */ var _common_js_utils_Analytics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../common/js/utils/Analytics */ "./resources/assets/fe/common/js/utils/Analytics.js");
/* harmony import */ var _common_js_components_Subscribe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/js/components/Subscribe */ "./resources/assets/fe/common/js/components/Subscribe.js");
...
window.HashtagCms = {};
window.HashtagCms.Subscribe = new _common_js_components_Subscribe__WEBPACK_IMPORTED_MODULE_2__["default"]();
window.HashtagCms.Analytics = new _common_js_utils_Analytics__WEBPACK_IMPORTED_MODULE_1__["default"]();
})();
